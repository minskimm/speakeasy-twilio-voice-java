...
public class ListDialingPermissionsHrsPrefixesRequest {
    ...
    @JsonCreator
    public ListDialingPermissionsHrsPrefixesRequest(
            String isoCode,
    ...
    public ListDialingPermissionsHrsPrefixesRequest(
            String isoCode) {
        this(isoCode, Optional.empty(), Optional.empty(), Optional.empty());
    }
     ...
     * How many resources to return in each list page. The default is 50, and the maximum is 1000.
     */
    public ListDialingPermissionsHrsPrefixesRequest withPageSize(Optional<Long> pageSize) {
        Utils.checkNotNull(pageSize, "pageSize");
        this.pageSize = pageSize;
        return this;
    }
     ...
     * The page index. This value is simply for client state.
     */
    public ListDialingPermissionsHrsPrefixesRequest withPage(Optional<Long> page) {
        Utils.checkNotNull(page, "page");
        this.page = page;
        return this;
    }
     ...
     * The page token. This is provided by the API.
     */
    public ListDialingPermissionsHrsPrefixesRequest withPageToken(Optional<String> pageToken) {
        Utils.checkNotNull(pageToken, "pageToken");
        this.pageToken = pageToken;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ListDialingPermissionsHrsPrefixesRequest other = (ListDialingPermissionsHrsPrefixesRequest) o;
        return 
    ...
    public String toString() {
        return Utils.toString(ListDialingPermissionsHrsPrefixesRequest.class,
                "isoCode", isoCode,
                "pageSize", pageSize,
                "page", page,
                "pageToken", pageToken);
    ...
    public final static class Builder {
        ...
        public ListDialingPermissionsHrsPrefixesRequest build() {
            return new ListDialingPermissionsHrsPrefixesRequest(
                isoCode,
                pageSize,
                page,
                pageToken);
