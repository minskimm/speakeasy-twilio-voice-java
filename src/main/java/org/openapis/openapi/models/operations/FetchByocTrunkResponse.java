...
public class FetchByocTrunkResponse implements Response {
     ...
     * HTTP response status code for this operation
     */
    public FetchByocTrunkResponse withStatusCode(int statusCode) {
        Utils.checkNotNull(statusCode, "statusCode");
        this.statusCode = statusCode;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public FetchByocTrunkResponse withRawResponse(HttpResponse<InputStream> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
     ...
     * OK
     */
    public FetchByocTrunkResponse withVoiceV1ByocTrunk(VoiceV1ByocTrunk voiceV1ByocTrunk) {
        Utils.checkNotNull(voiceV1ByocTrunk, "voiceV1ByocTrunk");
     ...
     * OK
     */
    public FetchByocTrunkResponse withVoiceV1ByocTrunk(Optional<? extends VoiceV1ByocTrunk> voiceV1ByocTrunk) {
        Utils.checkNotNull(voiceV1ByocTrunk, "voiceV1ByocTrunk");
        this.voiceV1ByocTrunk = voiceV1ByocTrunk;
        return this;
    }

    public FetchByocTrunkResponse withHeaders(Map<String, List<String>> headers) {
    ...
    public boolean equals(java.lang.Object o) {
        ...
        FetchByocTrunkResponse other = (FetchByocTrunkResponse) o;
        return 
    ...
    public String toString() {
        return Utils.toString(FetchByocTrunkResponse.class,
    ...
    public final static class Builder {
        ...
        public FetchByocTrunkResponse build() {
            return new FetchByocTrunkResponse(
                contentType,
                statusCode,
                rawResponse,
                voiceV1ByocTrunk,
