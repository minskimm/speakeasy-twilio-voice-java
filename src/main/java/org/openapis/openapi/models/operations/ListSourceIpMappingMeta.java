...
public class ListSourceIpMappingMeta {
    ...
    @JsonCreator
    public ListSourceIpMappingMeta(
    ...
    public ListSourceIpMappingMeta withFirstPageUrl(String firstPageUrl) {
        Utils.checkNotNull(firstPageUrl, "firstPageUrl");
        this.firstPageUrl = Optional.ofNullable(firstPageUrl);
        return this;
    }

    public ListSourceIpMappingMeta withFirstPageUrl(Optional<String> firstPageUrl) {
        Utils.checkNotNull(firstPageUrl, "firstPageUrl");
        this.firstPageUrl = firstPageUrl;
        return this;
    }

    public ListSourceIpMappingMeta withKey(String key) {
        Utils.checkNotNull(key, "key");
        this.key = Optional.ofNullable(key);
        return this;
    }

    public ListSourceIpMappingMeta withKey(Optional<String> key) {
        Utils.checkNotNull(key, "key");
        this.key = key;
        return this;
    }

    public ListSourceIpMappingMeta withNextPageUrl(String nextPageUrl) {
        Utils.checkNotNull(nextPageUrl, "nextPageUrl");
        this.nextPageUrl = JsonNullable.of(nextPageUrl);
        return this;
    }

    public ListSourceIpMappingMeta withNextPageUrl(JsonNullable<String> nextPageUrl) {
        Utils.checkNotNull(nextPageUrl, "nextPageUrl");
        this.nextPageUrl = nextPageUrl;
        return this;
    }

    public ListSourceIpMappingMeta withPage(long page) {
        Utils.checkNotNull(page, "page");
        this.page = Optional.ofNullable(page);
        return this;
    }

    public ListSourceIpMappingMeta withPage(Optional<Long> page) {
        Utils.checkNotNull(page, "page");
        this.page = page;
        return this;
    }

    public ListSourceIpMappingMeta withPageSize(long pageSize) {
        Utils.checkNotNull(pageSize, "pageSize");
        this.pageSize = Optional.ofNullable(pageSize);
        return this;
    }

    public ListSourceIpMappingMeta withPageSize(Optional<Long> pageSize) {
        Utils.checkNotNull(pageSize, "pageSize");
        this.pageSize = pageSize;
        return this;
    }

    public ListSourceIpMappingMeta withPreviousPageUrl(String previousPageUrl) {
        Utils.checkNotNull(previousPageUrl, "previousPageUrl");
        this.previousPageUrl = JsonNullable.of(previousPageUrl);
        return this;
    }

    public ListSourceIpMappingMeta withPreviousPageUrl(JsonNullable<String> previousPageUrl) {
        Utils.checkNotNull(previousPageUrl, "previousPageUrl");
        this.previousPageUrl = previousPageUrl;
        return this;
    }

    public ListSourceIpMappingMeta withUrl(String url) {
        Utils.checkNotNull(url, "url");
        this.url = Optional.ofNullable(url);
        return this;
    }

    public ListSourceIpMappingMeta withUrl(Optional<String> url) {
        Utils.checkNotNull(url, "url");
        this.url = url;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ListSourceIpMappingMeta other = (ListSourceIpMappingMeta) o;
        return 
    ...
    public String toString() {
        return Utils.toString(ListSourceIpMappingMeta.class,
    ...
    public final static class Builder {
        ...
        public ListSourceIpMappingMeta build() {
            return new ListSourceIpMappingMeta(
                firstPageUrl,
                key,
                nextPageUrl,
                page,
