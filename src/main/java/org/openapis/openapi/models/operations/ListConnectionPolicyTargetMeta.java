...
public class ListConnectionPolicyTargetMeta {
    ...
    @JsonCreator
    public ListConnectionPolicyTargetMeta(
    ...
    public ListConnectionPolicyTargetMeta withFirstPageUrl(String firstPageUrl) {
        Utils.checkNotNull(firstPageUrl, "firstPageUrl");
        this.firstPageUrl = Optional.ofNullable(firstPageUrl);
        return this;
    }

    public ListConnectionPolicyTargetMeta withFirstPageUrl(Optional<String> firstPageUrl) {
        Utils.checkNotNull(firstPageUrl, "firstPageUrl");
        this.firstPageUrl = firstPageUrl;
        return this;
    }

    public ListConnectionPolicyTargetMeta withKey(String key) {
        Utils.checkNotNull(key, "key");
        this.key = Optional.ofNullable(key);
        return this;
    }

    public ListConnectionPolicyTargetMeta withKey(Optional<String> key) {
        Utils.checkNotNull(key, "key");
        this.key = key;
        return this;
    }

    public ListConnectionPolicyTargetMeta withNextPageUrl(String nextPageUrl) {
        Utils.checkNotNull(nextPageUrl, "nextPageUrl");
        this.nextPageUrl = JsonNullable.of(nextPageUrl);
        return this;
    }

    public ListConnectionPolicyTargetMeta withNextPageUrl(JsonNullable<String> nextPageUrl) {
        Utils.checkNotNull(nextPageUrl, "nextPageUrl");
        this.nextPageUrl = nextPageUrl;
        return this;
    }

    public ListConnectionPolicyTargetMeta withPage(long page) {
        Utils.checkNotNull(page, "page");
        this.page = Optional.ofNullable(page);
        return this;
    }

    public ListConnectionPolicyTargetMeta withPage(Optional<Long> page) {
        Utils.checkNotNull(page, "page");
        this.page = page;
        return this;
    }

    public ListConnectionPolicyTargetMeta withPageSize(long pageSize) {
        Utils.checkNotNull(pageSize, "pageSize");
        this.pageSize = Optional.ofNullable(pageSize);
        return this;
    }

    public ListConnectionPolicyTargetMeta withPageSize(Optional<Long> pageSize) {
        Utils.checkNotNull(pageSize, "pageSize");
        this.pageSize = pageSize;
        return this;
    }

    public ListConnectionPolicyTargetMeta withPreviousPageUrl(String previousPageUrl) {
        Utils.checkNotNull(previousPageUrl, "previousPageUrl");
        this.previousPageUrl = JsonNullable.of(previousPageUrl);
        return this;
    }

    public ListConnectionPolicyTargetMeta withPreviousPageUrl(JsonNullable<String> previousPageUrl) {
        Utils.checkNotNull(previousPageUrl, "previousPageUrl");
        this.previousPageUrl = previousPageUrl;
        return this;
    }

    public ListConnectionPolicyTargetMeta withUrl(String url) {
        Utils.checkNotNull(url, "url");
        this.url = Optional.ofNullable(url);
        return this;
    }

    public ListConnectionPolicyTargetMeta withUrl(Optional<String> url) {
        Utils.checkNotNull(url, "url");
        this.url = url;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ListConnectionPolicyTargetMeta other = (ListConnectionPolicyTargetMeta) o;
        return 
    ...
    public String toString() {
        return Utils.toString(ListConnectionPolicyTargetMeta.class,
    ...
    public final static class Builder {
        ...
        public ListConnectionPolicyTargetMeta build() {
            return new ListConnectionPolicyTargetMeta(
                firstPageUrl,
                key,
                nextPageUrl,
                page,
