...
public class ListConnectionPolicyTargetRequest {
    ...
    @JsonCreator
    public ListConnectionPolicyTargetRequest(
    ...
    public ListConnectionPolicyTargetRequest(
            String connectionPolicySid) {
        this(connectionPolicySid, Optional.empty(), Optional.empty(), Optional.empty());
    }
     ...
     * How many resources to return in each list page. The default is 50, and the maximum is 1000.
     */
    public ListConnectionPolicyTargetRequest withPageSize(Optional<Long> pageSize) {
        Utils.checkNotNull(pageSize, "pageSize");
        this.pageSize = pageSize;
        return this;
    }
     ...
     * The page index. This value is simply for client state.
     */
    public ListConnectionPolicyTargetRequest withPage(Optional<Long> page) {
        Utils.checkNotNull(page, "page");
        this.page = page;
        return this;
    }
     ...
     * The page token. This is provided by the API.
     */
    public ListConnectionPolicyTargetRequest withPageToken(Optional<String> pageToken) {
        Utils.checkNotNull(pageToken, "pageToken");
        this.pageToken = pageToken;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ListConnectionPolicyTargetRequest other = (ListConnectionPolicyTargetRequest) o;
        return 
    ...
    public String toString() {
        return Utils.toString(ListConnectionPolicyTargetRequest.class,
    ...
    public final static class Builder {
        ...
        public ListConnectionPolicyTargetRequest build() {
            return new ListConnectionPolicyTargetRequest(
                connectionPolicySid,
                pageSize,
                page,
                pageToken);
