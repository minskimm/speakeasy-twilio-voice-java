...
public class Meta {
    ...
    public Meta withFirstPageUrl(String firstPageUrl) {
        Utils.checkNotNull(firstPageUrl, "firstPageUrl");
        this.firstPageUrl = Optional.ofNullable(firstPageUrl);
        return this;
    }

    public Meta withFirstPageUrl(Optional<String> firstPageUrl) {
        Utils.checkNotNull(firstPageUrl, "firstPageUrl");
        this.firstPageUrl = firstPageUrl;
        return this;
    }
    ...
    public Meta withKey(Optional<String> key) {
        Utils.checkNotNull(key, "key");
        this.key = key;
        return this;
    }

    public Meta withNextPageUrl(String nextPageUrl) {
        Utils.checkNotNull(nextPageUrl, "nextPageUrl");
        this.nextPageUrl = JsonNullable.of(nextPageUrl);
        return this;
    }

    public Meta withNextPageUrl(JsonNullable<String> nextPageUrl) {
        Utils.checkNotNull(nextPageUrl, "nextPageUrl");
        this.nextPageUrl = nextPageUrl;
        return this;
    }
    ...
    public Meta withPage(Optional<Long> page) {
        Utils.checkNotNull(page, "page");
        this.page = page;
        return this;
    }

    public Meta withPageSize(long pageSize) {
        Utils.checkNotNull(pageSize, "pageSize");
        this.pageSize = Optional.ofNullable(pageSize);
        return this;
    }

    public Meta withPageSize(Optional<Long> pageSize) {
        Utils.checkNotNull(pageSize, "pageSize");
        this.pageSize = pageSize;
        return this;
    }

    public Meta withPreviousPageUrl(String previousPageUrl) {
        Utils.checkNotNull(previousPageUrl, "previousPageUrl");
        this.previousPageUrl = JsonNullable.of(previousPageUrl);
        return this;
    }

    public Meta withPreviousPageUrl(JsonNullable<String> previousPageUrl) {
        Utils.checkNotNull(previousPageUrl, "previousPageUrl");
        this.previousPageUrl = previousPageUrl;
        return this;
    }

    public Meta withUrl(String url) {
        Utils.checkNotNull(url, "url");
        this.url = Optional.ofNullable(url);
        return this;
    }

    public Meta withUrl(Optional<String> url) {
        Utils.checkNotNull(url, "url");
        this.url = url;
        return this;
    }
