...
public class ListIpRecordMeta {
    ...
    public ListIpRecordMeta withFirstPageUrl(String firstPageUrl) {
        Utils.checkNotNull(firstPageUrl, "firstPageUrl");
        this.firstPageUrl = Optional.ofNullable(firstPageUrl);
        return this;
    }

    public ListIpRecordMeta withFirstPageUrl(Optional<String> firstPageUrl) {
        Utils.checkNotNull(firstPageUrl, "firstPageUrl");
        this.firstPageUrl = firstPageUrl;
        return this;
    }

    public ListIpRecordMeta withKey(String key) {
        Utils.checkNotNull(key, "key");
        this.key = Optional.ofNullable(key);
        return this;
    }

    public ListIpRecordMeta withKey(Optional<String> key) {
        Utils.checkNotNull(key, "key");
        this.key = key;
        return this;
    }

    public ListIpRecordMeta withNextPageUrl(String nextPageUrl) {
        Utils.checkNotNull(nextPageUrl, "nextPageUrl");
        this.nextPageUrl = JsonNullable.of(nextPageUrl);
        return this;
    }

    public ListIpRecordMeta withNextPageUrl(JsonNullable<String> nextPageUrl) {
        Utils.checkNotNull(nextPageUrl, "nextPageUrl");
        this.nextPageUrl = nextPageUrl;
        return this;
    }

    public ListIpRecordMeta withPage(long page) {
        Utils.checkNotNull(page, "page");
        this.page = Optional.ofNullable(page);
        return this;
    }

    public ListIpRecordMeta withPage(Optional<Long> page) {
        Utils.checkNotNull(page, "page");
        this.page = page;
        return this;
    }

    public ListIpRecordMeta withPageSize(long pageSize) {
        Utils.checkNotNull(pageSize, "pageSize");
        this.pageSize = Optional.ofNullable(pageSize);
        return this;
    }

    public ListIpRecordMeta withPageSize(Optional<Long> pageSize) {
        Utils.checkNotNull(pageSize, "pageSize");
        this.pageSize = pageSize;
        return this;
    }

    public ListIpRecordMeta withPreviousPageUrl(String previousPageUrl) {
        Utils.checkNotNull(previousPageUrl, "previousPageUrl");
        this.previousPageUrl = JsonNullable.of(previousPageUrl);
        return this;
    }

    public ListIpRecordMeta withPreviousPageUrl(JsonNullable<String> previousPageUrl) {
        Utils.checkNotNull(previousPageUrl, "previousPageUrl");
        this.previousPageUrl = previousPageUrl;
        return this;
    }

    public ListIpRecordMeta withUrl(String url) {
        Utils.checkNotNull(url, "url");
        this.url = Optional.ofNullable(url);
        return this;
    }

    public ListIpRecordMeta withUrl(Optional<String> url) {
        Utils.checkNotNull(url, "url");
        this.url = url;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ListIpRecordMeta other = (ListIpRecordMeta) o;
        return 
    ...
    public String toString() {
        return Utils.toString(ListIpRecordMeta.class,
    ...
    public final static class Builder {
        ...
        public ListIpRecordMeta build() {
            return new ListIpRecordMeta(
                firstPageUrl,
                key,
                nextPageUrl,
                page,
