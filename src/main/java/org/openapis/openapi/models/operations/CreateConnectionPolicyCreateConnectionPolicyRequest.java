...
public class CreateConnectionPolicyCreateConnectionPolicyRequest {
     ...
     * A descriptive string that you create to describe the resource. It is not unique and can be up to 255 characters long.
     */
    public CreateConnectionPolicyCreateConnectionPolicyRequest withFriendlyName(Optional<String> friendlyName) {
        Utils.checkNotNull(friendlyName, "friendlyName");
        this.friendlyName = friendlyName;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        CreateConnectionPolicyCreateConnectionPolicyRequest other = (CreateConnectionPolicyCreateConnectionPolicyRequest) o;
        return 
    ...
    public String toString() {
        return Utils.toString(CreateConnectionPolicyCreateConnectionPolicyRequest.class,
    ...
    public final static class Builder {
        ...
        public CreateConnectionPolicyCreateConnectionPolicyRequest build() {
            return new CreateConnectionPolicyCreateConnectionPolicyRequest(
                friendlyName);
        }
    }
}
