...
public class DeleteSourceIpMappingRequest {
    ...
    @JsonCreator
    public DeleteSourceIpMappingRequest(
            String sid) {
    ...
    public boolean equals(java.lang.Object o) {
        ...
        DeleteSourceIpMappingRequest other = (DeleteSourceIpMappingRequest) o;
        return 
    ...
    public String toString() {
        return Utils.toString(DeleteSourceIpMappingRequest.class,
                "sid", sid);
    }
    ...
    public final static class Builder {
        ...
        public DeleteSourceIpMappingRequest build() {
            return new DeleteSourceIpMappingRequest(
                sid);
        }
    }
}
