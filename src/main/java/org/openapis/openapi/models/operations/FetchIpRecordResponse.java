...
public class FetchIpRecordResponse implements Response {
     ...
     * HTTP response status code for this operation
     */
    public FetchIpRecordResponse withStatusCode(int statusCode) {
        Utils.checkNotNull(statusCode, "statusCode");
        this.statusCode = statusCode;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public FetchIpRecordResponse withRawResponse(HttpResponse<InputStream> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
     ...
     * OK
     */
    public FetchIpRecordResponse withVoiceV1IpRecord(VoiceV1IpRecord voiceV1IpRecord) {
        Utils.checkNotNull(voiceV1IpRecord, "voiceV1IpRecord");
     ...
     * OK
     */
    public FetchIpRecordResponse withVoiceV1IpRecord(Optional<? extends VoiceV1IpRecord> voiceV1IpRecord) {
        Utils.checkNotNull(voiceV1IpRecord, "voiceV1IpRecord");
        this.voiceV1IpRecord = voiceV1IpRecord;
        return this;
    }

    public FetchIpRecordResponse withHeaders(Map<String, List<String>> headers) {
    ...
    public boolean equals(java.lang.Object o) {
        ...
        FetchIpRecordResponse other = (FetchIpRecordResponse) o;
        return 
    ...
    public String toString() {
        return Utils.toString(FetchIpRecordResponse.class,
    ...
    public final static class Builder {
        ...
        public FetchIpRecordResponse build() {
            return new FetchIpRecordResponse(
                contentType,
                statusCode,
                rawResponse,
                voiceV1IpRecord,
