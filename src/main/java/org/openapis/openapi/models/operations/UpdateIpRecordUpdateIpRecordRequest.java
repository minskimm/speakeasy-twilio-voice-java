...
public class UpdateIpRecordUpdateIpRecordRequest {
     ...
     * A descriptive string that you create to describe the resource. It is not unique and can be up to 255 characters long.
     */
    public UpdateIpRecordUpdateIpRecordRequest withFriendlyName(Optional<String> friendlyName) {
        Utils.checkNotNull(friendlyName, "friendlyName");
        this.friendlyName = friendlyName;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        UpdateIpRecordUpdateIpRecordRequest other = (UpdateIpRecordUpdateIpRecordRequest) o;
        return 
    ...
    public String toString() {
        return Utils.toString(UpdateIpRecordUpdateIpRecordRequest.class,
    ...
    public final static class Builder {
        ...
        public UpdateIpRecordUpdateIpRecordRequest build() {
            return new UpdateIpRecordUpdateIpRecordRequest(
                friendlyName);
        }
    }
}
