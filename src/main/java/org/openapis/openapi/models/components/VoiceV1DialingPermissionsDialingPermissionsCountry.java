...
public class VoiceV1DialingPermissionsDialingPermissionsCountry {
    ...
    @JsonInclude(Include.NON_ABSENT)
    @JsonProperty("links")
    private JsonNullable<? extends VoiceV1DialingPermissionsDialingPermissionsCountryLinks> links;
    ...
    public VoiceV1DialingPermissionsDialingPermissionsCountry(
            ...
            @JsonProperty("links") JsonNullable<? extends VoiceV1DialingPermissionsDialingPermissionsCountryLinks> links) {
    ...
    @SuppressWarnings("unchecked")
    @JsonIgnore
    public JsonNullable<VoiceV1DialingPermissionsDialingPermissionsCountryLinks> links() {
        return (JsonNullable<VoiceV1DialingPermissionsDialingPermissionsCountryLinks>) links;
    }
     ...
     * The [ISO country code](https://en.wikipedia.org/wiki/ISO_3166-1_alpha-2).
     */
    public VoiceV1DialingPermissionsDialingPermissionsCountry withIsoCode(JsonNullable<String> isoCode) {
        Utils.checkNotNull(isoCode, "isoCode");
        this.isoCode = isoCode;
        return this;
    }
     ...
     * The name of the country.
     */
    public VoiceV1DialingPermissionsDialingPermissionsCountry withName(JsonNullable<String> name) {
        Utils.checkNotNull(name, "name");
        this.name = name;
        return this;
    }
     ...
     * The name of the continent in which the country is located.
     */
    public VoiceV1DialingPermissionsDialingPermissionsCountry withContinent(JsonNullable<String> continent) {
        Utils.checkNotNull(continent, "continent");
        this.continent = continent;
        return this;
    }
     ...
     * The E.164 assigned [country codes(s)](https://www.itu.int/itudoc/itu-t/ob-lists/icc/e164_763.html)
     */
    public VoiceV1DialingPermissionsDialingPermissionsCountry withCountryCodes(List<String> countryCodes) {
        Utils.checkNotNull(countryCodes, "countryCodes");
     ...
     * The E.164 assigned [country codes(s)](https://www.itu.int/itudoc/itu-t/ob-lists/icc/e164_763.html)
     */
    public VoiceV1DialingPermissionsDialingPermissionsCountry withCountryCodes(JsonNullable<? extends List<String>> countryCodes) {
        Utils.checkNotNull(countryCodes, "countryCodes");
        this.countryCodes = countryCodes;
        return this;
    }
     ...
     * Whether dialing to low-risk numbers is enabled.
     */
    public VoiceV1DialingPermissionsDialingPermissionsCountry withLowRiskNumbersEnabled(JsonNullable<Boolean> lowRiskNumbersEnabled) {
        Utils.checkNotNull(lowRiskNumbersEnabled, "lowRiskNumbersEnabled");
        this.lowRiskNumbersEnabled = lowRiskNumbersEnabled;
        return this;
    }
     ...
     * Whether dialing to high-risk special services numbers is enabled. These prefixes include number ranges allocated by the country and include premium numbers, special services, shared cost, and others
     */
    public VoiceV1DialingPermissionsDialingPermissionsCountry withHighRiskSpecialNumbersEnabled(JsonNullable<Boolean> highRiskSpecialNumbersEnabled) {
        Utils.checkNotNull(highRiskSpecialNumbersEnabled, "highRiskSpecialNumbersEnabled");
        this.highRiskSpecialNumbersEnabled = highRiskSpecialNumbersEnabled;
        return this;
    }
     ...
     * Whether dialing to high-risk [toll fraud](https://www.twilio.com/blog/how-to-protect-your-account-from-toll-fraud-with-voice-dialing-geo-permissions-html) numbers is enabled. These prefixes include narrow number ranges that have a high-risk of international revenue sharing fraud (IRSF) attacks, also known as [toll fraud](https://www.twilio.com/blog/how-to-protect-your-account-from-toll-fraud-with-voice-dialing-geo-permissions-html). These prefixes are collected from anti-fraud databases and verified by analyzing calls on our network. These prefixes are not available for download and are updated frequently
     */
    public VoiceV1DialingPermissionsDialingPermissionsCountry withHighRiskTollfraudNumbersEnabled(JsonNullable<Boolean> highRiskTollfraudNumbersEnabled) {
        Utils.checkNotNull(highRiskTollfraudNumbersEnabled, "highRiskTollfraudNumbersEnabled");
        this.highRiskTollfraudNumbersEnabled = highRiskTollfraudNumbersEnabled;
        return this;
    }
     ...
     * The absolute URL of this resource.
     */
    public VoiceV1DialingPermissionsDialingPermissionsCountry withUrl(JsonNullable<String> url) {
        Utils.checkNotNull(url, "url");
        this.url = url;
        return this;
    }
     ...
     * A list of URLs related to this resource.
     */
    public VoiceV1DialingPermissionsDialingPermissionsCountry withLinks(VoiceV1DialingPermissionsDialingPermissionsCountryLinks links) {
        Utils.checkNotNull(links, "links");
     ...
     * A list of URLs related to this resource.
     */
    public VoiceV1DialingPermissionsDialingPermissionsCountry withLinks(JsonNullable<? extends VoiceV1DialingPermissionsDialingPermissionsCountryLinks> links) {
        Utils.checkNotNull(links, "links");
        this.links = links;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        VoiceV1DialingPermissionsDialingPermissionsCountry other = (VoiceV1DialingPermissionsDialingPermissionsCountry) o;
        return 
    ...
    public String toString() {
        return Utils.toString(VoiceV1DialingPermissionsDialingPermissionsCountry.class,
                "isoCode", isoCode,
                "name", name,
                "continent", continent,
    ...
    public final static class Builder {
        ...
        private JsonNullable<? extends VoiceV1DialingPermissionsDialingPermissionsCountryLinks> links = JsonNullable.undefined();  
         ...
         * A list of URLs related to this resource.
         */
        public Builder links(VoiceV1DialingPermissionsDialingPermissionsCountryLinks links) {
            Utils.checkNotNull(links, "links");
            this.links = JsonNullable.of(links);
            return this;
        }
         ...
         * A list of URLs related to this resource.
         */
        public Builder links(JsonNullable<? extends VoiceV1DialingPermissionsDialingPermissionsCountryLinks> links) {
            Utils.checkNotNull(links, "links");
            this.links = links;
            return this;
        }
        
        public VoiceV1DialingPermissionsDialingPermissionsCountry build() {
            return new VoiceV1DialingPermissionsDialingPermissionsCountry(
                isoCode,
                name,
                continent,
                countryCodes,
